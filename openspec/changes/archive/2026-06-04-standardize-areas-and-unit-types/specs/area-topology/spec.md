...
- **THEN** painel exibe: nome, área (exibida em ha, armazenada em m²), Zona (com cor e ícone), quantidade de Unidades, e ações (Editar, Arquivar)

#### Scenario: Detalhes de Unidade
- **WHEN** usuário seleciona uma Unidade Menor
- **THEN** painel exibe: nome, tipo (via tabela tipos_unidade), área (em m², se registrada), Talhão pai, Zona herdada, e ações (Editar, Arquivar)
...
### Requirement: Visualização de áreas
O sistema SHALL exibir áreas em m² para Unidades Menores e em ha para Talhões e Propriedades.

#### Scenario: Exibir área de unidade em m²
- **WHEN** unidade menor possui área registrada
- **THEN** sistema exibe o valor em m² (ex: "30 m²")

#### Scenario: Exibir área de talhão em ha
- **WHEN** talhão possui área registrada
- **THEN** sistema exibe o valor convertido de m² para ha (dividido por 10.000) com 2 casas decimais (ex: "0.80 ha")

#### Scenario: Exibir área de propriedade em ha
- **WHEN** propriedade possui totalArea registrada
- **THEN** sistema exibe o valor convertido de m² para ha com 2 casas decimais (ex: "11.30 ha")
